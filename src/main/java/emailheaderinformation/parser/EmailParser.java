...
public class EmailParser {
	 ...
	 * HUB05.ad.oak.ox.ac.uk (163.1.154.231) with Microsoft SMTP Server id
	 * 14.3.169.1; Sat, 14 Nov 2015 10:55:35 +0000
	 *
	 * received = "Received" ":" ; one per relay ["from" domain] ; sending host
	 * ["by" domain] ; receiving host ["via" atom] ; physical path *("with" atom)
	 * ; link/mail protocol ["id" msg-id] ; receiver msg id ["for" addr-spec] ;
	 * initial form ";" date-time ; time received
	 *
	 ...
	 * domain-literal domain-ref = atom domain-literal = "[" *(dtext /
	 * quoted-pair) "]" dtext = <any CHAR excluding "[", ; => may be folded "]",
	 ...
	 *
	 * zone = "UT" / "GMT" ; Universal Time ; North American : UT / "EST" / "EDT"
	 * ; Eastern: - 5/ - 4 / "CST" / "CDT" ; Central: - 6/ - 5 / "MST" / "MDT" ;
	 * Mountain: - 7/ - 6 / "PST" / "PDT" ; Pacific: - 8/ - 7 / 1ALPHA ; Military:
	 * Z = UT; ; A:-1; (J not used) ; M:-12; N:+1; Y:+12 / ( ("+" / "-") 4DIGIT )
