...
public class SystemCommandExecutor {
	 ...
	 * commands.add("www.google.com"); SystemCommandExecutor commandExecutor = new
	 * SystemCommandExecutor(commands); commandExecutor.executeCommand();
	 * 
	...
	public int executeCommand() throws IOException, InterruptedException {
		...
		try {
			...
			// from the command.
			// the inputstream handler gets a reference to our stdOutput in case we
			// need to write
